...
#undef A_FUGUE
  ...
  { "cryptonight-monero", ALGO_CRYPTONIGHT_MONERO, "", (1ULL << 32), (1ULL << 32), (1ULL << 32), 0, 0, 0xFF, 0xFFFFULL, 0x0000ffffUL, 6, 0, 0, cryptonight_regenhash, NULL, queue_cryptonight_kernel, gen_hash, NULL },
